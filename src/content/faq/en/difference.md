...
* Zonemaster can be used to test [undelegated domain names](https://zonemaster.net/sv/faq#what-is-an-undelegated-domain-test).
* Zonemaster can be used to test [DS records before their publication in the parent zone](https://zonemaster.net/sv/faq#can-i-test-the-ds-records-before-they-are-published).
