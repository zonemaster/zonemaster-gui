...
Le jugement de Zonemaster repose principalement sur les normes techniques du DNS telles qu'elles sont définies dans les RFCs. Le jugement est également fondé sur les bonnes pratiques du DNS, dont la définition est moins stricte.

Tous les tests de Zonemaster sont définis dans les [documents de spécifications de cas de test (en anglais)](https://github.com/zonemaster/zonemaster/tree/master/docs/public/specifications/tests#zonemaster-test-case-specifications), dans lesquels on peut trouver les références aux documents normatifs pour chaque cas de test.
