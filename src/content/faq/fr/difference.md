...
* Tous les tests qu'effectue Zonemaster sont définis dans des documents de spécification de cas de test, qui se trouvent dans les [documents de spécifications de cas de test](https://github.com/zonemaster/zonemaster/tree/master/docs/public/specifications/tests#zonemaster-test-case-specifications) (en anglais).
* Zonemaster peut être utilisé pour tester des [noms de domaines non délégués](https://zonemaster.net/fr/faq#what-is-an-undelegated-domain-test).
