...
Zonemaster sender flere DNS-spørringer til navnetjenere som vert for det testede domenenavnet og også til navnetjenere som vert for overordnet sone for det domenenavnet.
