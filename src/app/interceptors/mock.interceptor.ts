...
const urls = [
...

  {
    ...
    json: {'jsonrpc': '2.0', 'id': 1572254972327, 'result': {
        ...
        }, 'hash_id': 'a0fbcbf6c5ff5842', 'creation_time': '2019-10-28 09:29:26.288692', 'id': 49640, 'results':[]
      }
    }
  },
  ...
  // FR25 - Should open a modal that contains four export possibilities
  {
    ...
    json: {'jsonrpc': '2.0', 'id': 1572254972327, 'result': {
        ...
        }, 'hash_id': '226f6d4f44ae3f80', 'creation_time': '2019-10-28 09:29:26.288692', 'id': 49640, 'results':
